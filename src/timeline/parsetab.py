...
_lr_productions = [
  ...
  ('thread -> temp_thread','thread',1,'p_thread3','tlparser.py',147),
  ('point -> SYMBOL_NAME ASSIGN DATE','point',3,'p_point','tlparser.py',157),
  ('point -> SYMBOL_NAME ASSIGN DATE PARAMETER','point',4,'p_point1','tlparser.py',164),
  ('interval -> SYMBOL_NAME ASSIGN DATE RANGE DATE','interval',5,'p_interval','tlparser.py',175),
  ('interval -> SYMBOL_NAME ASSIGN DATE RANGE DATE PARAMETER','interval',6,'p_interval1','tlparser.py',182),
]
