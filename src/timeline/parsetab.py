...
_lr_productions = [
  ...
  ('temp_section -> START_SECTION COLOR thread','temp_section',3,'p_section_color','tlparser.py',68),
  ('temp_section -> temp_section thread','temp_section',2,'p_section1','tlparser.py',75),
  ('section -> temp_section','section',1,'p_section2','tlparser.py',83),
  ('temp_thread -> START_THREAD point','temp_thread',2,'p_thread','tlparser.py',92),
  ('temp_thread -> START_THREAD interval','temp_thread',2,'p_thread','tlparser.py',93),
  ('temp_thread -> temp_thread point','temp_thread',2,'p_thread1','tlparser.py',99),
  ('temp_thread -> temp_thread interval','temp_thread',2,'p_thread1','tlparser.py',100),
  ('thread -> temp_thread','thread',1,'p_thread2','tlparser.py',107),
  ('point -> SYMBOL_NAME ASSIGN DATE','point',3,'p_point','tlparser.py',116),
  ('point -> SYMBOL_NAME ASSIGN DATE PARAMETER','point',4,'p_point1','tlparser.py',123),
  ('interval -> SYMBOL_NAME ASSIGN DATE RANGE DATE','interval',5,'p_interval','tlparser.py',133),
  ('interval -> SYMBOL_NAME ASSIGN DATE RANGE DATE PARAMETER','interval',6,'p_interval1','tlparser.py',140),
]
